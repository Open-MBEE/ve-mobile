...
class DocumentsScreen extends Component {
  ...
  constructor(props) {
    ...
    this.props.getDocuments(this.projectId);
  }
  ...
  render() {
    ...
    return (
      <Container>
        <Content>
          <List
            dataArray={this.props.documents}
            renderRow={document =>
              <ListItem
                onPress={ () => this.props.navigation.navigate('Views', { projectId: this.projectId, viewId: document.id, title: document.name }) } >
                <Left>
                  <Text>
                    {document.name}
                  </Text>
